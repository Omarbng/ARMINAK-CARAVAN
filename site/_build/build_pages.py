...
<section class="hero" id="hero"
         data-video-desktop="assets/hero/hero-desktop.mp4"
         data-video-mobile="assets/hero/hero-mobile.mp4">
      ...
      <div class="hero__layer">
        <picture>
          <source media="(max-width: 768px), (orientation: portrait)" type="image/webp"
                  srcset="assets/hero/poster-mobile.webp">
          <source media="(max-width: 768px), (orientation: portrait)" type="image/jpeg"
                  srcset="assets/hero/poster-mobile.jpg">
          <source type="image/webp" srcset="assets/hero/poster-desktop.webp">
          <img class="hero__poster" src="assets/hero/poster-desktop.jpg" alt=""
...
<section class="section corridor" id="corridors">
  <div class="shell">
    ...
    <div class="corridor__grid">
      <div>
        <div class="corridor__globe" id="corridorGlobe" aria-hidden="true"><i></i><i></i><i></i><i></i></div>
        <p class="corridor__hint" id="corridorHint" hidden data-i18n="corridor.drag">Drag to turn · true great-circle lanes</p>
      </div>

      <table class="corridor__lanes" id="corridorLanes" hidden>
        <tr><th data-i18n="corridor.thWaypoint">Waypoint</th><th data-i18n="corridor.thPort">Port</th><th data-i18n="corridor.thRole">Role</th><th data-i18n="corridor.thPos">Position</th></tr>
        <tr><td data-i18n="corridor.n1">Black Sea</td><td>Novorossiysk</td><td class="role" data-i18n="corridor.r1">Origination</td><td class="pos">44.72° N 37.77° E</td></tr>
        <tr><td data-i18n="corridor.n2">Turkey</td><td>Mersin</td><td class="role" data-i18n="corridor.r2">Origination</td><td class="pos">36.80° N 34.63° E</td></tr>
        <tr><td data-i18n="corridor.n3">Central Asia</td><td>Almaty</td><td class="role" data-i18n="corridor.r3">Origination</td><td class="pos">43.24° N 76.89° E</td></tr>
        <tr><td data-i18n="corridor.n4">Jebel Ali</td><td>Jebel Ali</td><td class="role" data-i18n="corridor.r4">Transhipment hub</td><td class="pos">25.01° N 55.06° E</td></tr>
        <tr><td data-i18n="corridor.n5">East Africa</td><td>Mombasa</td><td class="role" data-i18n="corridor.r5">Delivery</td><td class="pos">4.04° S 39.67° E</td></tr>
      </table>
    </div>
