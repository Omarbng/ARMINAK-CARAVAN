...
<!-- Full-bleed desert film. Two separately reframed cuts: the 16:9 one for
     ...
     Live sand still draws over it (mountHeroSand). v1-v4 remain on disk under
     the same six filenames, so going back is only the paths below. -->
<section class="hero" id="hero"
         data-video-desktop="assets/hero/v5/hero-desktop.mp4"
         data-video-mobile="assets/hero/v5/hero-mobile.mp4">
      ...
      <div class="hero__layer">
        <picture>
          <source media="(max-width: 768px), (orientation: portrait)" type="image/webp"
                  srcset="assets/hero/v5/poster-mobile.webp">
          <source media="(max-width: 768px), (orientation: portrait)" type="image/jpeg"
                  srcset="assets/hero/v5/poster-mobile.jpg">
          <source type="image/webp" srcset="assets/hero/v5/poster-desktop.webp">
          <img class="hero__poster" src="assets/hero/v5/poster-desktop.jpg" alt=""
